def zkfaceon(self):
    ...
    if self.pinwidthtrynumber == 1:
        self.data_seq1 = hex( int( data_seq[0], 16 ) + int( 'd', 16 ) ).lstrip("0x")
        self.data_seq2 = hex( int( data_seq[1], 16 ) + int( '78', 16 ) ).lstrip("0x")
        desc = ": +d, +78"
    else:
        self.data_seq1 = hex( int( data_seq[0], 16 ) + int( 'c', 16 ) ).lstrip("0x")
        self.data_seq2 = hex( int( data_seq[1], 16 ) + int( '78', 16 ) ).lstrip("0x")
        desc = ": +e, +78"
